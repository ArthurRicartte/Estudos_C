...
//Retornar parte real do complexo:
double Parte_Real(Complexo* c){
    if (!c){
        printf("Complexo vazio!");
        exit(1);
    }
...
//Retornar parte imaginaria do complexo:
double Parte_Imaginaria(Complexo* c){
    if (!c){
        printf("Complexo vazio!");
        exit(1);
    }
